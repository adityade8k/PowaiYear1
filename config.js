...
export const config = {
    ...
    instructions: {
        ...
        mobileText: "Lock controls to reveal joystick<br>Left stick: move<br>Right stick: look<br><br>Go close to an orb and <br> place the cursor on it <br> to view a memory",
